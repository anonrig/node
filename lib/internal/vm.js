 ...
 * @param {boolean} [options.shouldValidateIfErrorIsEsmSyntax=true] - Whether to throw an error if the code contains syntax errors.
...
function internalCompileFunction(code, params, options) {
  ...
  const {
    ...
    shouldValidateIfErrorIsEsmSyntax,
  } = options;
  ...
  if (shouldValidateIfErrorIsEsmSyntax != null) {
    validateBoolean(shouldValidateIfErrorIsEsmSyntax, 'options.shouldValidateIfErrorIsEsmSyntax');
  }
  ...
  if (shouldValidateIfErrorIsEsmSyntax) {
    return result;
  }
